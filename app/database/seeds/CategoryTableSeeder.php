    ...
    public function run()
    {
       	...
       	$fixtures = array(
        	...
        	array(	'name' => 'PRODUITS GRAND PUBLIC',
        			'description' => 'L’entreprise lauréate sera récompensée grâce à l’intérêt, l’utilité ou le design particulièrement innovants qu’elle aura apportés à un article de grande consommation. Eco-conception et impact écologique (bilan carbone…) seront particulièrement appréciés.'),
        	array(	'name' => 'SANTÉ / BIOTECHNOLOGIES',
        		  	'description' => 'L’entreprise récompensée aura conçu un médicament, un vaccin ou tout autre produit, équipement ou service apportant une amélioration sensible du confort ou un l’allongement de la vie, de la protection de la santé humaine ou de la prise en charge des malades.'),
        	array(	'name' => 'SERVICES',
