...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'candidate_informations' => 'Fonction de la personne en charge de la candidature',
        'candidate_name' => 'Nom de la personne en charge de la candidature',
        'candidate_firstname' => 'Prénom de la personne en charge de la candidature',
        'leader_position' => 'Informations concernant le dirigeant de votre entreprise',
        'leader_name' => 'Nom du dirigeant de votre entreprise',
        'leader_firstname' => 'Prénom du dirigeant de votre entreprise',
        'leader_email' => 'Email du dirigeant de votre entreprise',
        'leader_phone' => 'Téléphone du dirigeant de votre entreprise',
